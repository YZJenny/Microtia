...
ID='C1'
DATA <- Read10X(paste('/local/yzj/JingMA_ORI/data/',ID,'/',sep=''))
...
############
saveRDS(subpbmc,paste('/local/yzj/JingMA_NEW/res/QC/ALL/RDS/pbmc_QC_',ID,'.RDS',sep=''))
############
...
### merge
############
pbmc_C1 <- readRDS('/local/yzj/JingMA_NEW/res/QC/ALL/RDS/pbmc_QC_C1.RDS')
pbmc_C2 <- readRDS('/local/yzj/JingMA_NEW/res/QC/ALL/RDS/pbmc_QC_C2.RDS')
pbmc_C3 <- readRDS('/local/yzj/JingMA_NEW/res/QC/ALL/RDS/pbmc_QC_C3.RDS')
pbmc_C4 <- readRDS('/local/yzj/JingMA_NEW/res/QC/ALL/RDS/pbmc_QC_C4.RDS')
pbmc_C5 <- readRDS('/local/yzj/JingMA_NEW/res/QC/ALL/RDS/pbmc_QC_C5.RDS')
pbmc_C6 <- readRDS('/local/yzj/JingMA_NEW/res/QC/ALL/RDS/pbmc_QC_C6.RDS')

pbmc_M1 <- readRDS('/local/yzj/JingMA_NEW/res/QC/ALL/RDS/pbmc_QC_M1.RDS')
pbmc_M2 <- readRDS('/local/yzj/JingMA_NEW/res/QC/ALL/RDS/pbmc_QC_M2.RDS')
pbmc_M3 <- readRDS('/local/yzj/JingMA_NEW/res/QC/ALL/RDS/pbmc_QC_M3.RDS')
...
saveRDS(QC.info,'/local/yzj/JingMA_NEW/res/QC/ALL/RDS/QC_info.RDS')
