...
Carti <- c(unlist(strsplit(df_GO_pre[6, 'geneID'],  '/')),unlist(strsplit(df_GO_pre[7, 'geneID'],  '/')))
ECM <- c(unlist(strsplit(df_GO_pre[3, 'geneID'],  '/')),unlist(strsplit(df_GO_pre[4, 'geneID'],  '/')))
Ion <- unlist(strsplit(df_GO_pre[5, 'geneID'],  '/'))
ROS <- c(unlist(strsplit(df_GO_pre[1, 'geneID'],  '/')),'TXN')
S100 <- unlist(strsplit(df_GO_pre[2, 'geneID'],  '/'))
...
plot_CSC_down <-
    ...
    geom_node_point(aes(size = page_rank, fill = group),shape=21, color = 'transparent') +
    ...
    geom_node_text(aes(filter = group == 1,label=name),size=2, repel = T) + 
    geom_node_text(aes(filter = group == 2,label=name),size=2, repel = T) + 
    geom_node_text(aes(filter = group == 3,label=name),size=2, repel = T) + 
    geom_node_text(aes(filter = group == 4,label=name),size=2, repel = T) + 
    geom_node_text(aes(filter = group == 5,label=name),size=2, repel = T) + 
...
Stem <- c(unlist(strsplit(df_GO_pre[1, 'geneID'], '/')),unlist(strsplit(df_GO_pre[2, 'geneID'], '/')),unlist(strsplit(df_GO_pre[3, 'geneID'], '/')))
ROS <- unlist(strsplit(df_GO_pre[4, 'geneID'], '/'))
NFK <- c(unlist(strsplit(df_GO_pre[5, 'geneID'],'/')),unlist(strsplit(df_GO_pre[6, 'geneID'],'/')))
Apop <- c(unlist(strsplit(df_GO_pre[7, 'geneID'],'/')),unlist(strsplit(df_GO_pre[8, 'geneID'],'/')))
Stab <- c(unlist(strsplit(df_GO_pre[9, 'geneID'],'/')),unlist(strsplit(df_GO_pre[10, 'geneID'],'/')))
IL <- c(unlist(strsplit(df_GO_pre[11, 'geneID'],'/')),unlist(strsplit(df_GO_pre[12, 'geneID'],'/')),
        unlist(strsplit(df_GO_pre[13, 'geneID'],'/')),unlist(strsplit(df_GO_pre[14, 'geneID'],'/')))
...
plot_CSC_up <-
    ...
    geom_node_text(aes(filter = group == 1,label=name),size=1.5, repel = T) + 
    geom_node_text(aes(filter = group == 2,label=name),size=1.5, repel = T) + 
    geom_node_text(aes(filter = group == 3,label=name),size=1.5, repel = T) + 
    geom_node_text(aes(filter = group == 4,label=name),size=1.5, repel = T) + 
    geom_node_text(aes(filter = group == 5,label=name),size=1.5, repel = T) + 
    geom_node_text(aes(filter = group == 6,label=name),size=1.5, repel = T) + 
